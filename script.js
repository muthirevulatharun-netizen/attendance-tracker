...
const attendanceDatabase = {
    "24691A32R8": [
        { subject: "Aptitude", present: 2, total: 2},
        { subject: "Discrete Mathematical Structures", present: 5, total: 5},
        {subject: "environmental science", present: 3, total: 4},
        { subject: "Introduction To Data Science", present: 5, total: 5 },
        { subject: "Data Engineering", present: 5, total: 5},
        { subject: "Data Science Laboratory", present: 3, total: 3 },
        { subject: "NPTEL-1", present: 4, total: 4},
        { subject: "NPTEL-2", present: 3, total: 3},
        { subject: "Code Tantra", present: 4, total: 4 },
        {subject: "Data engineering laboratory", present: 3, total: 6},
    ],
    "24691A32S8": [
        { subject: "Aptitude", present: 2, total: 2 },
        { subject: "Discrete Mathematical Structures", present: 5, total: 5},
        {subject: "environmental science", present: 4, total: 5},
        { subject: "Introduction To Data Science", present: 5, total: 6},
        { subject: "Data Engineering", present: 5, total: 5 },
        { subject: "Data Science Laboratory", present: 3, total: 3 },
        { subject: "NPTEL-1", present: 4, total: 4 },
        { subject: "NPTEL-2", present: 3, total: 3 },
    ...
    "24691A32T7": [
        { subject: "Aptitude", present: 1, total: 2},
        { subject: "Discrete Mathematical Structures", present: 3, total: 4},
        {subject: "environmental science", present: 2, total: 4},
        { subject: "Introduction To Data Science", present: 4, total: 5 },
        ...
        { subject: "NPTEL-2", present: 1, total: 3 },
        { subject: "Code Tantra", present: 2, total: 4 },
        {subject: "Data engineering laboratory", present: 0, total: 0},
    ]
};
